...
class TransFusionBBoxCoder(BaseBBoxCoder):
    ...
    def encode(self, dst_boxes):
        ...
        # targets[:, 6] = dst_boxes[:, 6]/torch.pi
...
class HungarianAssigner3D(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_labels, cls_pred, train_cfg):
        ...
        cls_cost = torch.nan_to_num(cls_cost)
        reg_cost = torch.nan_to_num(reg_cost)
        iou_cost = torch.nan_to_num(iou_cost)
